...
Description: "Entrée FR-Instruction-au-patient: IHE-PCC - Simple-ObservationCette entrée permet d’enregistrer une instruction au patient sous forme codée (c’est notamment le cas pour les prescriptions d’examens de biologie médicale)."
* classCode MS
* classCode = #OBS
* moodCode MS
* moodCode = #EVN
...
* value MS
* value ^short = "Instruction au patient sous forme codée"
* value ^definition = "Instruction au patient sous forme codée. JDV dépendant du cas d’usage.
