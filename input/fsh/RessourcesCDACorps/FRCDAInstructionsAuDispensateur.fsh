...
Description: "Entrée FR-Instructions-au-dispensateur: IHE-PCC - Medication Fulfillment InstructionsToute prescription peut faire l'objet d'instructions au dispensateur (pharmacien), par exemple pour indiquer que le traitement doit être étiqueté dans une langue étrangère, etc …  
