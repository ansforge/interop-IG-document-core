...
* code MS
* code 1..1
* code ^short = "Code de l'élément référencé Le 'code' est obligatoire et doit être identique au code de l'élément référencé. Si l'élément référencé n'a pas codé, alors le 'code' doit être nullFlavor='NA'."
* code ^definition = "Code de l'élément référencé"
* code.nullFlavor ^short = "Fixé: NA"