...
Description: "DICOM Part 20 - Clinical Information SectionCette section permet d'enregistrer les détails cliniques liés au patient, tels que : Justification de la demande dans la sous-section FR-DICOM-demande-examen [1..1] Finalité de l'examen dans la même sous-section FR-DICOM-demande-examen [0..1] Antécédents médicaux significatifs et pertinents pour cet examen dans la sous-section FR-Historique-medical [0..1]Antécédents chirurgicaux pertinents pour cet examen dans la sous-section FR-Historique-medical [0..1] Contre-indications et facteurs de risques connus au moment de la demande et dépendant de la modalité dans la sous-section FR-Historique-medical [0..1]"
* templateId 1..2
* templateId ^slicing.discriminator.type = #value
* templateId ^slicing.discriminator.path = "root"
* templateId ^slicing.rules = #open
* templateId contains frSectionDicomInformationsCliniques 1..1
and dicomStudyComponentManagement 1..1
...
* templateId[dicomStudyComponentManagement].root = "1.2.840.10008.9.2"
* templateId[dicomStudyComponentManagement] ^short = "Conformité FR-DICOM-Informations-cliniques (CI-SIS)"
* code MS
* code 1..1
