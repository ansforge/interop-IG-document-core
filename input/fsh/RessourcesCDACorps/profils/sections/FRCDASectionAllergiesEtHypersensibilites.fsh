...
Description: "IHE-PCC - Allergies-And-Other-Adverse-ReactionsLa section 'Allergies et hypersensibilités' permet de décrire la liste codée des allergies et hypersensibilités (médicaments, environnements, aliments,..) précisant notamment l'agent et les réactions observées."
* templateId 1..3
* templateId ^slicing.discriminator.type = #value
* templateId ^slicing.discriminator.path = "root"
* templateId ^slicing.rules = #open
* templateId contains iheAllergiesAndOtherAdverseReactionsSection 1..1
and hl7SectionMedications 1..1
...
* templateId[hl7SectionMedications].root = "2.16.840.1.113883.10.20.1.2"
* templateId[hl7SectionMedications] ^short = "Déclaration de conformité de la section aux spécifications IHE PCC"
* templateId[frSectionAllergiesEtHypersensibilites].root = "1.2.250.1.213.1.1.2.137"
* templateId[frSectionAllergiesEtHypersensibilites] ^short = "Déclaration de conformité de la section aux spécifications IHE PCC"
* code MS
* code 1..1
