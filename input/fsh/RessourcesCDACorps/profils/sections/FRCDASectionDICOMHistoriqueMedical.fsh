...
Description: "DICOM Part 20 - Medical (General) History SectionCette sous-section permet d'enregistrer les antécédents médicaux, les antécédents chirurgicaux et les contre-indications."
* templateId 1..2
* templateId ^slicing.discriminator.type = #value
* templateId ^slicing.discriminator.path = "root"
* templateId ^slicing.rules = #open
* templateId contains frSectionDicomHistoriqueMedical 1..1
and hl7SectionAssessmentAndPlan 1..1
...
* templateId[hl7SectionAssessmentAndPlan].root = "2.16.840.1.113883.10.20.22.2.39"
* templateId[hl7SectionAssessmentAndPlan] ^short = "Conformité FR-DICOM-Historique-medical (CI-SIS)"
* code MS
* code 1..1
