...
Description: "Entrée FR-Image-illustrative: Image illustrativeCette entrée, utilisable dans toute entrée, permet de positionner une image, référencée dans le texte de la section par l’attribut renderMultimedia.referencedObject. 
...
* value MS
* value 1..1
* value ^short = "Image encodée en Base6"
* value ^definition = "Image encodée en Base6. Les attributs de cet élément prennent les valeurs suivantes :
