...
// Élément racine
* group[=].element[+].code = #FRLMImageIllustrative.id
* group[=].element[=].target.code = #FRCDAImageIllustrative.identifier
* group[=].element[=].target.equivalence = #equivalent
// language
* group[=].element[+].code = #FRLMImageIllustrative.languageCode
* group[=].element[=].target.code = #FRCDAImageIllustrative.content.language
* group[=].element[=].target.equivalence = #equivalent 
// data
* group[=].element[+].code = #FRLMImageIllustrative.value
* group[=].element[=].target.code = #FRCDAImageIllustrative.content.data
* group[=].element[=].target.equivalence = #equivalent
// Type de média
* group[=].element[+].code = #FRLMImageIllustrative.value.mediaType
* group[=].element[=].target.code = #FRCDAImageIllustrative.content.contentType
* group[=].element[=].target.equivalence = #equivalent 
// Pas besoin de fixer representation : en FHIR c’est implicite via le type de l’Attachment ou la présence d’un data Base64.
* group[=].element[+].code = #FRLMImageIllustrative.value.representation
* group[=].element[=].target.equivalence = #unmatched
// Sujet
* group[=].element[+].code = #FRLMImageIllustrative.subject
* group[=].element[=].target.code = #FRCDAImageIllustrative.subject:Patient
* group[=].element[=].target.equivalence = #equivalent 
// Specimen
* group[=].element[+].code = #FRLMImageIllustrative.specimen
* group[=].element[=].target.code = #FRCDAImageIllustrative.subject:Specimen
* group[=].element[=].target.equivalence = #equivalent
// Performer
* group[=].element[+].code = #FRLMImageIllustrative.performer
* group[=].element[=].target.code = #FRCDAImageIllustrative.operator.extension:performer
* group[=].element[=].target.equivalence = #equivalent 
// author
* group[=].element[+].code = #FRLMImageIllustrative.author
* group[=].element[=].target.code = #FRCDAImageIllustrative.operator.extension:author
* group[=].element[=].target.equivalence = #equivalent
// informant
* group[=].element[+].code = #FRLMImageIllustrative.informant
* group[=].element[=].target.code = #FRCDAImageIllustrative.operator.extension:informant
* group[=].element[=].target.equivalence = #equivalent 
// participant
* group[=].element[+].code = #FRLMImageIllustrative.participant
* group[=].element[=].target.code = #FRCDAImageIllustrative.operator.extension:participant
* group[=].element[=].target.equivalence = #equivalent 
// entryRelationship (Acte ou plan de soins à l'origine de l'image)
* group[=].element[+].code = #FRLMImageIllustrative.entryRelationship
* group[=].element[=].target.code = #FRCDAImageIllustrative.basedOn
* group[=].element[=].target.equivalence = #equivalent 
// reference
* group[=].element[+].code = #FRLMImageIllustrative.reference
* group[=].element[=].target.code = #FRCDAImageIllustrative.partOf
* group[=].element[=].target.equivalence = #equivalent 
// Contexte ou justification de l'image (précondition)
* group[=].element[+].code = #FRLMImageIllustrative.precondition
* group[=].element[=].target.code = #FRCDAImageIllustrative.reasonCode
* group[=].element[=].target.equivalence = #equivalent 
