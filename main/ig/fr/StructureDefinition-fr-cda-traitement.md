...
## Modèle logique: CDA - FR Traitement 
...
Obligatoire : 10 éléments(25 éléments obligatoire(s) imbriqué(s))
 Must-Support : 44 éléments
...
* [CDA - FR Prescription (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-prescription)](StructureDefinition-fr-cda-prescription.md)
* [CDA - FR Traitement subordonne (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-traitement-subordonne)](StructureDefinition-fr-cda-traitement-subordonne.md)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-traitement.csv), [Excel](../StructureDefinition-fr-cda-traitement.xlsx) 
