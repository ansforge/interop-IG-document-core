...
* [Medication - FR Medication Document (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-medication-document)](StructureDefinition-fr-medication-document.md)
...
* [FR Encounter Care Document (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-encounter-care-document)](StructureDefinition-fr-encounter-care-document.md)
...
* [Observation - FR Observation Work Related Accident Document (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-observation-work-related-accident-document)](StructureDefinition-fr-observation-work-related-accident-document.md)
...
* [https://profiles.ihe.net/PHARM/MPD/StructureDefinition/ihe-ext-offLabel](https://profiles.ihe.net/PHARM/MPD/1.0.0-comment-2/StructureDefinition-ihe-ext-offLabel.html)
...
* [http://hl7.org/fhir/5.0/StructureDefinition/extension-MedicationRequest.dispenseRequest.dispenserInstruction](http://hl7.org/fhir/uv/xver-r5.r4/0.1.0/StructureDefinition-ext-R5-MedicationRequest.dis.dispenserInstruction.html)
