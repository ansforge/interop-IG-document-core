...
## Modèle logique: CDA - FR Traitement prescrit subordonne 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-traitement-prescrit-subordonne.csv), [Excel](../StructureDefinition-fr-cda-traitement-prescrit-subordonne.xlsx) 
