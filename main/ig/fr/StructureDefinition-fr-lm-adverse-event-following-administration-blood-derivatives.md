...
## Modèle logique: Logical model - FR LM Adverse Events Following Administration of Blood Derivatives 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-adverse-event-following-administration-blood-derivatives.csv), [Excel](../StructureDefinition-fr-lm-adverse-event-following-administration-blood-derivatives.xlsx) 
