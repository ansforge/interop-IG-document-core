...
## Modèle logique: CDA - participant 
...
Cette structure est dérivée de [Participant1](http://hl7.org/cda/stds/core/2.0.3-sd/StructureDefinition-Participant1.html) 
...
* [CDA - associatedEntity (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-associated-entity)](StructureDefinition-fr-cda-associated-entity.md)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-participant-entete.csv), [Excel](../StructureDefinition-fr-cda-participant-entete.xlsx) 
