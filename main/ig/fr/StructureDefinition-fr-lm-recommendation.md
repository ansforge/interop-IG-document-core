...
## Modèle logique: Logical model - FR LM Recommendation 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-recommendation.csv), [Excel](../StructureDefinition-fr-lm-recommendation.xlsx) 
