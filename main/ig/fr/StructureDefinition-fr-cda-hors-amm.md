...
## Modèle logique: CDA - FR Hors AMM 
...
* [IVL_TS: Interval (V3 Data Type) (http://hl7.org/cda/stds/core/StructureDefinition/IVL-TS)](http://hl7.org/cda/stds/core/2.0.3-sd/StructureDefinition-IVL-TS.html)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-hors-amm.csv), [Excel](../StructureDefinition-fr-cda-hors-amm.xlsx) 
