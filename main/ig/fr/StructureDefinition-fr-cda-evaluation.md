...
## Modèle logique: CDA - FR Evaluation 
...
* [CDA - FR Evaluation Composant (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-evaluation-composant)](StructureDefinition-fr-cda-evaluation-composant.md)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-evaluation.csv), [Excel](../StructureDefinition-fr-cda-evaluation.xlsx) 
