...
## Modèle logique: Logical model - FR LM Adverse Events During Hospitalization 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-adverse-event-during-hospitalization.csv), [Excel](../StructureDefinition-fr-lm-adverse-event-during-hospitalization.xlsx) 
