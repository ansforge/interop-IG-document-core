...
## Modèle logique: Logical model - FR LM CarePlans 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-care-plans.csv), [Excel](../StructureDefinition-fr-lm-care-plans.xlsx) 
