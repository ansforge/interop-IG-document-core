...
## Modèle logique: CDA - FR Instruction au patient 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-instruction-au-patient.csv), [Excel](../StructureDefinition-fr-cda-instruction-au-patient.xlsx) 
