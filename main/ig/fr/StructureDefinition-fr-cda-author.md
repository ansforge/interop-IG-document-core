...
Cette structure est dérivée de [Author](http://hl7.org/cda/stds/core/2.0.3-sd/StructureDefinition-Author.html) 
...
* [CDA - assignedAuthor (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-assigned-author)](StructureDefinition-fr-cda-assigned-author.md)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-author.csv), [Excel](../StructureDefinition-fr-cda-author.xlsx) 
