...
## Modèle logique: CDA - FR DICOM Complications 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-dicom-complications.csv), [Excel](../StructureDefinition-fr-cda-dicom-complications.xlsx) 
