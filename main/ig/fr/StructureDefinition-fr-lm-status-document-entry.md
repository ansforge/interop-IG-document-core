...
## Modèle logique: Logical model - FR LM Statut du document 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-status-document-entry.csv), [Excel](../StructureDefinition-fr-lm-status-document-entry.xlsx) 
