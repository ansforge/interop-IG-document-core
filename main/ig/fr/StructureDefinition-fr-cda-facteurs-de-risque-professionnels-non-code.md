...
## Modèle logique: CDA - FR Facteurs de risque professionnels non code 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-facteurs-de-risque-professionnels-non-code.csv), [Excel](../StructureDefinition-fr-cda-facteurs-de-risque-professionnels-non-code.xlsx) 
