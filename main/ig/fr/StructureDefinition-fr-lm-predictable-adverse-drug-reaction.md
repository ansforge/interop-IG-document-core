...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-predictable-adverse-drug-reaction.csv), [Excel](../StructureDefinition-fr-lm-predictable-adverse-drug-reaction.xlsx) 
