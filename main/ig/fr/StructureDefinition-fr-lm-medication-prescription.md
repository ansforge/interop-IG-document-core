...
## Modèle logique: Logical model - FR LM FR LM Medication Prescription 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-medication-prescription.csv), [Excel](../StructureDefinition-fr-lm-medication-prescription.xlsx) 
