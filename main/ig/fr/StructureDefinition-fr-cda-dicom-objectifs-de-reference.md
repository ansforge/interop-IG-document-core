...
## Modèle logique: CDA - FR DICOM Objectifs de référence 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-dicom-objectifs-de-reference.csv), [Excel](../StructureDefinition-fr-cda-dicom-objectifs-de-reference.xlsx) 
