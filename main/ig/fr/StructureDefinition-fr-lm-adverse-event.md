...
## Modèle logique: Logical model - FR LM Adverse Event 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-adverse-event.csv), [Excel](../StructureDefinition-fr-lm-adverse-event.xlsx) 
