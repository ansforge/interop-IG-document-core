...
## Modèle logique: CDA - FR Traitement prescrit 
...
Obligatoire : 20 éléments(29 éléments obligatoire(s) imbriqué(s))
 Must-Support : 43 éléments
...
* [CDA - FR Reference interne (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-reference-interne)](StructureDefinition-fr-cda-reference-interne.md)
* [CDA - FR Traitement prescrit subordonne (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-traitement-prescrit-subordonne)](StructureDefinition-fr-cda-traitement-prescrit-subordonne.md)
* [CDA - FR Reference item plan traitement (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-reference-item-plan-traitement)](StructureDefinition-fr-cda-reference-item-plan-traitement.md)
* [CDA - FR Instructions au patient (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-instructions-au-patient)](StructureDefinition-fr-cda-instructions-au-patient.md)
* [CDA - FR Instructions au dispensateur (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-instructions-au-dispensateur)](StructureDefinition-fr-cda-instructions-au-dispensateur.md)
* [CDA - FR Quantite de produit (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-quantite-de-produit)](StructureDefinition-fr-cda-quantite-de-produit.md)
* [CDA - FR Autorisation Substitution (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-autorisation-substitution)](StructureDefinition-fr-cda-autorisation-substitution.md)
* [CDA - FR Periode de renouvellement (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-periode-de-renouvellement)](StructureDefinition-fr-cda-periode-de-renouvellement.md)
* [CDA - FR En rapport avec ALD (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-en-rapport-avec-ald)](StructureDefinition-fr-cda-en-rapport-avec-ald.md)
* [CDA - FR En rapport avec accident travail (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-en-rapport-avec-accident-travail)](StructureDefinition-fr-cda-en-rapport-avec-accident-travail.md)
* [CDA - FR En rapport avec la prevention (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-en-rapport-avec-la-prevention)](StructureDefinition-fr-cda-en-rapport-avec-la-prevention.md)
* [CDA - FR Non remboursable (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-non-remboursable)](StructureDefinition-fr-cda-non-remboursable.md)
* [CDA - FR Hors AMM (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-hors-amm)](StructureDefinition-fr-cda-hors-amm.md)
...
* The element 1 is sliced based on the value of SubstanceAdministration.author
* The element 1 is sliced based on the value of SubstanceAdministration.entryRelationship
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-traitement-prescrit.csv), [Excel](../StructureDefinition-fr-cda-traitement-prescrit.xlsx) 
