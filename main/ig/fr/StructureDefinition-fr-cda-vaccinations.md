...
## Modèle logique: CDA - FR Vaccinations 
...
* [CDA - FR Vaccination (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-vaccination)](StructureDefinition-fr-cda-vaccination.md)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-vaccinations.csv), [Excel](../StructureDefinition-fr-cda-vaccinations.xlsx) 
