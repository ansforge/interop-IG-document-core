...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-medical-devices-and-implants.csv), [Excel](../StructureDefinition-fr-lm-medical-devices-and-implants.xlsx) 
