...
## Modèle logique: CDA - encounterParticipant 
...
Cette structure est dérivée de [EncounterParticipant](http://hl7.org/cda/stds/core/2.0.3-sd/StructureDefinition-EncounterParticipant.html) 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-encounter-participant.csv), [Excel](../StructureDefinition-fr-cda-encounter-participant.xlsx) 
