...
## Modèle logique: CDA - FR Commentaire non code 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-commentaire-non-code.csv), [Excel](../StructureDefinition-fr-cda-commentaire-non-code.xlsx) 
