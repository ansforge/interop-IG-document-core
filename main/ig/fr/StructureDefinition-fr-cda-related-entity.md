...
## Modèle logique: CDA - relatedEntity 
...
Cette structure est dérivée de [RelatedEntity](http://hl7.org/cda/stds/core/2.0.3-sd/StructureDefinition-RelatedEntity.html) 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-related-entity.csv), [Excel](../StructureDefinition-fr-cda-related-entity.xlsx) 
