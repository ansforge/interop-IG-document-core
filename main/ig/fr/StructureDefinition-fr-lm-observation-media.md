...
* [Logical model - FR LM Patient (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-lm-patient)](StructureDefinition-fr-lm-patient.md)
* [Logical model - FR LM Specimen (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-lm-specimen)](StructureDefinition-fr-lm-specimen.md)
