...
## Modèle logique: CDA - FR Vaccination 
...
* [CDA - FR Rang de la vaccination (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-rang-de-la-vaccination)](StructureDefinition-fr-cda-rang-de-la-vaccination.md)
...
* [CDA - FR Dose antigene (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-dose-antigene)](StructureDefinition-fr-cda-dose-antigene.md)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-vaccination.csv), [Excel](../StructureDefinition-fr-cda-vaccination.xlsx) 
