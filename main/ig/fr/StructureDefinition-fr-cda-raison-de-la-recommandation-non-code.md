...
## Modèle logique: CDA - FR Raison de la recommandation non code 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-raison-de-la-recommandation-non-code.csv), [Excel](../StructureDefinition-fr-cda-raison-de-la-recommandation-non-code.xlsx) 
