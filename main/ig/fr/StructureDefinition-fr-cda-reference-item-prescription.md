...
## Modèle logique: CDA - FR Reference item prescription 
...
* [CDA - FR Traitement prescrit (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-traitement-prescrit)](StructureDefinition-fr-cda-traitement-prescrit.md)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-reference-item-prescription.csv), [Excel](../StructureDefinition-fr-cda-reference-item-prescription.xlsx) 
