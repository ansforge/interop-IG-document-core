...
## Modèle logique: Logical model - FR LM Hors AMM 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-hors-amm.csv), [Excel](../StructureDefinition-fr-lm-hors-amm.xlsx) 
