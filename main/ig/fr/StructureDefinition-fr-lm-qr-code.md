...
## Modèle logique: Logical model - FR LM QR Code 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-qr-code.csv), [Excel](../StructureDefinition-fr-lm-qr-code.xlsx) 
