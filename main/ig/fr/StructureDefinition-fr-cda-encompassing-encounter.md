...
## Modèle logique: CDA - encompassingEncounter 
...
Cette structure est dérivée de [EncompassingEncounter](http://hl7.org/cda/stds/core/2.0.3-sd/StructureDefinition-EncompassingEncounter.html) 
...
* [CDA - encounterParticipant (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-encounter-participant)](StructureDefinition-fr-cda-encounter-participant.md)
* [CDA - healthCareFacility (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-health-care-facility)](StructureDefinition-fr-cda-health-care-facility.md)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-encompassing-encounter.csv), [Excel](../StructureDefinition-fr-cda-encompassing-encounter.xlsx) 
