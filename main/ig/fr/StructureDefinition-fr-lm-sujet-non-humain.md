...
## Modèle logique: Logical model - FR LM Sujet non humain 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-sujet-non-humain.csv), [Excel](../StructureDefinition-fr-lm-sujet-non-humain.xlsx) 
