...
## Modèle logique: CDA - FR DICOM Cadres à afficher 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-dicom-cadres-a-afficher.csv), [Excel](../StructureDefinition-fr-cda-dicom-cadres-a-afficher.xlsx) 
