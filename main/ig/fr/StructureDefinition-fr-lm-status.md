...
## Modèle logique: Logical model - FR LM Statut 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-status.csv), [Excel](../StructureDefinition-fr-lm-status.xlsx) 
