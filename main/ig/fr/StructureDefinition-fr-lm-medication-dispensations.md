...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-medication-dispensations.csv), [Excel](../StructureDefinition-fr-lm-medication-dispensations.xlsx) 
