...
## Modèle logique: logical model- FR LM Functional Status 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-functional-status.csv), [Excel](../StructureDefinition-fr-lm-functional-status.xlsx) 
