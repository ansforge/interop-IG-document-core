...
## Modèle logique: Logical model - FR LM Immunization Recommendation 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-immunization-recommendation.csv), [Excel](../StructureDefinition-fr-lm-immunization-recommendation.xlsx) 
