...
## Modèle logique: Logical model - FR LM Evolution Adverse Event 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-evolution-adverse-event.csv), [Excel](../StructureDefinition-fr-lm-evolution-adverse-event.xlsx) 
