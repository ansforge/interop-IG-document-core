...
## Modèle logique: CDA - FR DICOM SOP instance observation 
...
Obligatoire : 7 éléments(1 élément obligatoire(s) imbriqué(s))
...
* [CDA - FR DICOM SOP instance observation subordonnee (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-dicom-sop-instance-observation-subordonnee)](StructureDefinition-fr-cda-dicom-sop-instance-observation-subordonnee.md)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-dicom-sop-instance-observation.csv), [Excel](../StructureDefinition-fr-cda-dicom-sop-instance-observation.xlsx) 
