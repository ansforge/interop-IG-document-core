...
## Modèle logique: CDA - FR Rang de la vaccination 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-rang-de-la-vaccination.csv), [Excel](../StructureDefinition-fr-cda-rang-de-la-vaccination.xlsx) 
