...
## Modèle logique: Logical model - FR LM Recherche de micro organismes 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-recherche-de-micro-organismes.csv), [Excel](../StructureDefinition-fr-lm-recherche-de-micro-organismes.xlsx) 
