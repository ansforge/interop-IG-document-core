...
## Modèle logique: CDA - FR Reference interne 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-reference-interne.csv), [Excel](../StructureDefinition-fr-cda-reference-interne.xlsx) 
