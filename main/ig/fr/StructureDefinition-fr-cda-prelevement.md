...
## Modèle logique: CDA - FR Prelevement 
...
Obligatoire : 10 éléments(15 éléments obligatoire(s) imbriqué(s))
...
* The element 1 is sliced based on the value of Procedure.entryRelationship.act.templateId
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-prelevement.csv), [Excel](../StructureDefinition-fr-cda-prelevement.xlsx) 
