...
## Modèle logique: Logical model - FR LM Location 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-location.csv), [Excel](../StructureDefinition-fr-lm-location.xlsx) 
