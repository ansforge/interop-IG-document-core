...
## Modèle logique: Logical model - FR LM Examination Report 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-examination-report.csv), [Excel](../StructureDefinition-fr-lm-examination-report.xlsx) 
