...
## Modèle logique: Logical model - FR LM Observation Result 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-observation-result.csv), [Excel](../StructureDefinition-fr-lm-observation-result.xlsx) 
