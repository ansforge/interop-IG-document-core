...
## Modèle logique: Logical model - FR LM Transfusion accidents 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-transfusion-accidents.csv), [Excel](../StructureDefinition-fr-lm-transfusion-accidents.xlsx) 
