...
## Modèle logique: CDA - FR Instructions au patient 
...
* [CDA - FR Instruction au patient (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-instruction-au-patient)](StructureDefinition-fr-cda-instruction-au-patient.md)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-instructions-au-patient.csv), [Excel](../StructureDefinition-fr-cda-instructions-au-patient.xlsx) 
