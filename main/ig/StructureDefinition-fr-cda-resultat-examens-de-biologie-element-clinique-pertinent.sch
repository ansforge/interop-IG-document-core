...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:Observation/f:entryRelationship/f:observation</sch:title>
    <sch:rule context="f:Observation/f:entryRelationship/f:observation">
      <sch:assert test="count(f:nullFlavor) &lt;= 1">nullFlavor: maximum cardinality of 'nullFlavor' is 1</sch:assert>
      <sch:assert test="count(f:typeId) &lt;= 1">typeId: maximum cardinality of 'typeId' is 1</sch:assert>
      ...
      <sch:assert test="count(f:code) &lt;= 1">code: maximum cardinality of 'code' is 1</sch:assert>
      <sch:assert test="count(f:derivationExpr) &lt;= 1">derivationExpr: maximum cardinality of 'derivationExpr' is 1</sch:assert>
      ...
      <sch:assert test="count(f:repeatNumber) &lt;= 1">repeatNumber: maximum cardinality of 'repeatNumber' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Observation/f:entryRelationship/f:observation/f:typeId</sch:title>
    <sch:rule context="f:Observation/f:entryRelationship/f:observation/f:typeId">
      <sch:assert test="count(f:nullFlavor) &lt;= 1">nullFlavor: maximum cardinality of 'nullFlavor' is 1</sch:assert>
      <sch:assert test="count(f:assigningAuthorityName) &lt;= 1">assigningAuthorityName: maximum cardinality of 'assigningAuthorityName' is 1</sch:assert>
      <sch:assert test="count(f:displayable) &lt;= 1">displayable: maximum cardinality of 'displayable' is 1</sch:assert>
      <sch:assert test="count(f:root) &gt;= 1">root: minimum cardinality of 'root' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Observation/f:entryRelationship/f:observation/f:code</sch:title>
    <sch:rule context="f:Observation/f:entryRelationship/f:observation/f:code">
      <sch:assert test="count(f:nullFlavor) &lt;= 1">nullFlavor: maximum cardinality of 'nullFlavor' is 1</sch:assert>
      <sch:assert test="count(f:code) &lt;= 1">code: maximum cardinality of 'code' is 1</sch:assert>
      <sch:assert test="count(f:codeSystem) &lt;= 1">codeSystem: maximum cardinality of 'codeSystem' is 1</sch:assert>
      <sch:assert test="count(f:codeSystemName) &lt;= 1">codeSystemName: maximum cardinality of 'codeSystemName' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Observation/f:entryRelationship/f:observation/f:code/f:originalText</sch:title>
    <sch:rule context="f:Observation/f:entryRelationship/f:observation/f:code/f:originalText">
      <sch:assert test="count(f:nullFlavor) &lt;= 1">nullFlavor: maximum cardinality of 'nullFlavor' is 1</sch:assert>
      <sch:assert test="count(f:compression) &lt;= 1">compression: maximum cardinality of 'compression' is 1</sch:assert>
      <sch:assert test="count(f:integrityCheck) &lt;= 1">integrityCheck: maximum cardinality of 'integrityCheck' is 1</sch:assert>
      <sch:assert test="count(f:integrityCheckAlgorithm) &lt;= 1">integrityCheckAlgorithm: maximum cardinality of 'integrityCheckAlgorithm' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Observation/f:entryRelationship/f:observation/f:statusCode</sch:title>
    <sch:rule context="f:Observation/f:entryRelationship/f:observation/f:statusCode">
      <sch:assert test="count(f:nullFlavor) &lt;= 1">nullFlavor: maximum cardinality of 'nullFlavor' is 1</sch:assert>
      <sch:assert test="count(f:code) &lt;= 1">code: maximum cardinality of 'code' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Observation/f:entryRelationship/f:observation/f:referenceRange</sch:title>
    <sch:rule context="f:Observation/f:entryRelationship/f:observation/f:referenceRange">
      <sch:assert test="count(f:nullFlavor) &lt;= 1">nullFlavor: maximum cardinality of 'nullFlavor' is 1</sch:assert>
      <sch:assert test="count(f:typeId) &lt;= 1">typeId: maximum cardinality of 'typeId' is 1</sch:assert>
      <sch:assert test="count(f:typeCode) &lt;= 1">typeCode: maximum cardinality of 'typeCode' is 1</sch:assert>
      <sch:assert test="count(f:observationRange) &gt;= 1">observationRange: minimum cardinality of 'observationRange' is 1</sch:assert>
      <sch:assert test="count(f:observationRange) &lt;= 1">observationRange: maximum cardinality of 'observationRange' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>f:Observation/f:entryRelationship/f:observation/f:referenceRange/f:typeId</sch:title>
    <sch:rule context="f:Observation/f:entryRelationship/f:observation/f:referenceRange/f:typeId">
      <sch:assert test="count(f:nullFlavor) &lt;= 1">nullFlavor: maximum cardinality of 'nullFlavor' is 1</sch:assert>
      <sch:assert test="count(f:assigningAuthorityName) &lt;= 1">assigningAuthorityName: maximum cardinality of 'assigningAuthorityName' is 1</sch:assert>
      <sch:assert test="count(f:displayable) &lt;= 1">displayable: maximum cardinality of 'displayable' is 1</sch:assert>
      <sch:assert test="count(f:root) &gt;= 1">root: minimum cardinality of 'root' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Observation/f:entryRelationship/f:observation/f:referenceRange/f:observationRange</sch:title>
    <sch:rule context="f:Observation/f:entryRelationship/f:observation/f:referenceRange/f:observationRange">
      <sch:assert test="count(f:nullFlavor) &lt;= 1">nullFlavor: maximum cardinality of 'nullFlavor' is 1</sch:assert>
      <sch:assert test="count(f:typeId) &lt;= 1">typeId: maximum cardinality of 'typeId' is 1</sch:assert>
      <sch:assert test="count(f:classCode) &lt;= 1">classCode: maximum cardinality of 'classCode' is 1</sch:assert>
      <sch:assert test="count(f:moodCode) &lt;= 1">moodCode: maximum cardinality of 'moodCode' is 1</sch:assert>
      ...
      <sch:assert test="count(f:value) &gt;= 1">value: minimum cardinality of 'value' is 1</sch:assert>
      <sch:assert test="count(f:value) &lt;= 1">value: maximum cardinality of 'value' is 1</sch:assert>
      <sch:assert test="count(f:interpretationCode) &gt;= 1">interpretationCode: minimum cardinality of 'interpretationCode' is 1</sch:assert>
      <sch:assert test="count(f:interpretationCode) &lt;= 1">interpretationCode: maximum cardinality of 'interpretationCode' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>f:Observation/f:entryRelationship/f:observation/f:referenceRange/f:observationRange/f:typeId</sch:title>
    <sch:rule context="f:Observation/f:entryRelationship/f:observation/f:referenceRange/f:observationRange/f:typeId">
      <sch:assert test="count(f:nullFlavor) &lt;= 1">nullFlavor: maximum cardinality of 'nullFlavor' is 1</sch:assert>
      <sch:assert test="count(f:assigningAuthorityName) &lt;= 1">assigningAuthorityName: maximum cardinality of 'assigningAuthorityName' is 1</sch:assert>
      <sch:assert test="count(f:displayable) &lt;= 1">displayable: maximum cardinality of 'displayable' is 1</sch:assert>
      <sch:assert test="count(f:root) &gt;= 1">root: minimum cardinality of 'root' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Observation/f:entryRelationship/f:observation/f:referenceRange/f:observationRange/f:interpretationCode</sch:title>
    <sch:rule context="f:Observation/f:entryRelationship/f:observation/f:referenceRange/f:observationRange/f:interpretationCode">
      <sch:assert test="count(f:nullFlavor) &lt;= 1">nullFlavor: maximum cardinality of 'nullFlavor' is 1</sch:assert>
      <sch:assert test="count(f:code) &lt;= 1">code: maximum cardinality of 'code' is 1</sch:assert>
      <sch:assert test="count(f:codeSystem) &lt;= 1">codeSystem: maximum cardinality of 'codeSystem' is 1</sch:assert>
      <sch:assert test="count(f:codeSystemName) &lt;= 1">codeSystemName: maximum cardinality of 'codeSystemName' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Observation/f:entryRelationship/f:observation/f:referenceRange/f:observationRange/f:sdtcPrecondition1</sch:title>
    <sch:rule context="f:Observation/f:entryRelationship/f:observation/f:referenceRange/f:observationRange/f:sdtcPrecondition1">
      <sch:assert test="count(f:nullFlavor) &lt;= 1">nullFlavor: maximum cardinality of 'nullFlavor' is 1</sch:assert>
      <sch:assert test="count(f:typeId) &lt;= 1">typeId: maximum cardinality of 'typeId' is 1</sch:assert>
      <sch:assert test="count(f:typeCode) &lt;= 1">typeCode: maximum cardinality of 'typeCode' is 1</sch:assert>
      <sch:assert test="count(f:conjunctionCode) &gt;= 1">conjunctionCode: minimum cardinality of 'conjunctionCode' is 1</sch:assert>
      <sch:assert test="count(f:conjunctionCode) &lt;= 1">conjunctionCode: maximum cardinality of 'conjunctionCode' is 1</sch:assert>
      <sch:assert test="count(f:criterion1) &gt;= 1">criterion1: minimum cardinality of 'criterion1' is 1</sch:assert>
      <sch:assert test="count(f:criterion1) &lt;= 1">criterion1: maximum cardinality of 'criterion1' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>f:Observation/f:entryRelationship/f:observation/f:referenceRange/f:observationRange/f:sdtcPrecondition1/f:typeId</sch:title>
    <sch:rule context="f:Observation/f:entryRelationship/f:observation/f:referenceRange/f:observationRange/f:sdtcPrecondition1/f:typeId">
      <sch:assert test="count(f:nullFlavor) &lt;= 1">nullFlavor: maximum cardinality of 'nullFlavor' is 1</sch:assert>
      <sch:assert test="count(f:assigningAuthorityName) &lt;= 1">assigningAuthorityName: maximum cardinality of 'assigningAuthorityName' is 1</sch:assert>
      <sch:assert test="count(f:displayable) &lt;= 1">displayable: maximum cardinality of 'displayable' is 1</sch:assert>
      <sch:assert test="count(f:root) &gt;= 1">root: minimum cardinality of 'root' is 1</sch:assert>
