...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.document.fr.core|current/StructureDefinition/StructureDefinition-fr-lm-predictable-adverse-drug-reaction.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "max" : "*",
      "type" : [{
        "code" : "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-lm-adverse-drug-reaction"
      }]
    }]
  }
}
