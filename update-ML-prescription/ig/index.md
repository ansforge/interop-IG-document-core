...
| Draft as of 2026-04-29 | *Computable Name*:FRDocumentCore |
...
* [Substance Admin Substitution](http://terminology.hl7.org/7.1.0/CodeSystem-v3-substanceAdminSubstitution.html): [FRCDAAutorisationSubstitution](StructureDefinition-fr-cda-autorisation-substitution.md), [FRLMMedicationDispense](StructureDefinition-fr-lm-medication-dispense.md), [FRLMPrescriptionItem](StructureDefinition-fr-lm-prescription-item.md) and [FRMedicationRequestDocument](StructureDefinition-fr-medication-request-document.md)
