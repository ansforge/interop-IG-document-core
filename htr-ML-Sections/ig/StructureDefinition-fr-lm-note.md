# Modèle logique métier - FR LM Note - ANS IG document core v0.1.0-snapshot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Modèle logique métier - FR LM Note**

## Logical Model: Modèle logique métier - FR LM Note 

| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-lm-note | *Version*:0.1.0-snapshot |
| Draft as of 2026-05-07 | *Computable Name*:FRLMNote |
...
```json
{
  ...
  "differential" : {
    "element" : [{
      "id" : "fr-lm-note",
      "path" : "fr-lm-note",
      "short" : "Modèle logique métier - FR LM Note",
