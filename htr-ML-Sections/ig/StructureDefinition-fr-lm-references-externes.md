...
| Draft as of 2026-05-07 | *Computable Name*:FRLMReferencesExternes |
...
* Utilise ce/t/te Modèle logique: [Modèle logique métier - FR LM Patient Education](StructureDefinition-fr-lm-patient-education.md) and [logical model - FR LM Procedures](StructureDefinition-fr-lm-procedures.md)
