...
| Draft as of 2026-05-07 | *Computable Name*:FRLMResultatsExamensBiologieMedicale |
...
* Utilise ce/t/te Modèle logique: [Modèle logique métier - FR LM Compte rendu de biologie de 1er niveau](StructureDefinition-fr-lm-result-data.md)
