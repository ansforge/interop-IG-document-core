...
| Draft as of 2026-05-07 | *Computable Name*:FRLMCarePlan |
...
* Utilise ce/t/te Modèle logique: [Logical model - FR LM CarePlans](StructureDefinition-fr-lm-care-plans.md) and [Modèle logique métier - FR LM Recommendation](StructureDefinition-fr-lm-recommendation.md)
