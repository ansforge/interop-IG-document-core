...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      "name" : "Modèle logique métier - FR LM Admission Evaluation",
    ...
    },
    {
      ...
      "name" : "Modèle logique métier - FR LM Encounter Information",
