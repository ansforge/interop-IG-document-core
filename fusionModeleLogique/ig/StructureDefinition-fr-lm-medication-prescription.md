...
| Draft as of 2026-04-30 | *Computable Name*:FRLMMedicationPrescription |
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "fr-lm-medication-prescription.sousSection",
      "path" : "fr-lm-medication-prescription.sousSection",
      "max" : "0"
    },
    {
      "id" : "fr-lm-medication-prescription.entree",
      "path" : "fr-lm-medication-prescription.entree",
      "min" : 1
    },
    {
      "id" : "fr-lm-medication-prescription.entree.traitementPrescrit",
      "path" : "fr-lm-medication-prescription.entree.traitementPrescrit",
