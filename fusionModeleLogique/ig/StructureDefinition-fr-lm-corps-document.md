...
| Draft as of 2026-04-30 | *Computable Name*:FRLMCorpsDocument |
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "fr-lm-corps-document.medicationsDispensation",
      "path" : "fr-lm-corps-document.medicationsDispensation",
      "short" : "Section Dispensation médicaments",
      "definition" : "Section Dispensation médicaments",
      "min" : 0,
      "max" : "*",
      "type" : [{
        "code" : "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-lm-medications-dispensation"
      }]
    },
    {
