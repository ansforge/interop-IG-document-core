...
| Draft as of 2026-04-30 | *Computable Name*:FRDocumentCore |
...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/fr-lm-medications-dispensation"
      },
      "name" : "Logical model - FR LM Medications Dispensation",
