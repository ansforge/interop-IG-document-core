...
| Draft as of 2026-02-25 | *Computable Name*:FRDocumentCore |
...
* [Substance Admin Substitution](http://terminology.hl7.org/7.0.1/CodeSystem-v3-substanceAdminSubstitution.html): [FRCDAAutorisationSubstitution](StructureDefinition-fr-cda-autorisation-substitution.md) and [FRMedicationRequestDocument](StructureDefinition-fr-medication-request-document.md)
...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      "description" : "Entrée FR-Evaluation-Composant: <p>Cette entrée permet de porter un résultat élémentaire (ex : score unitaire) répondant à une question faisant partie d’une évaluation.</p>",
      "exampleBoolean" : false,
      "groupingId" : "Ressources CDA corps"
    },
    {
    ...
    },
    {
      ...
      "description" : "Mapping des elements du modele metier FRLMAdministrationProduitDeSante vers le profil CDA FRCDADICOMAdministrationProduitDeSante, puis vers le profil FHIR FRMedicationAdministrationDocument.",
      "exampleBoolean" : false,
      "groupingId" : "Mapping ML-CDA-FHIR des composants élémentaires d'un document"
    },
    {
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ConceptMap/FRSectionImagingResultatsLMCDAFHIR"
      },
