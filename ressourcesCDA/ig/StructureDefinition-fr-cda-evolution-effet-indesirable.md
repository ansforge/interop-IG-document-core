# CDA - FR Evolution effet indesirable - ANS IG document core v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-evolution-effet-indesirable | *Version*:0.1.0 |
| Draft as of 2026-02-26 | *Computable Name*:FRCDAEvolutionEffetIndesirable |
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "Observation.templateId:frEvolutionEffetIndesirable",
      "path" : "Observation.templateId",
    ...
    {
      "id" : "Observation.templateId:frEvolutionEffetIndesirable.root",
