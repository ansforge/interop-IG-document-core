# CDA - FR DICOM Quantite subordonnee - ANS IG document core v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-dicom-quantite-subordonnee | *Version*:0.1.0 |
| Draft as of 2026-02-26 | *Computable Name*:FRCDADICOMQuantiteSubordonnee |

 
Entrée FR-DICOM-Quantite-subordonnee: <p>Cette entrée permet d’enregistrer les mesures quantitatives telles que les mesures linéaires, les mesures de surface, de volume et numériques en précisant : </p> 
