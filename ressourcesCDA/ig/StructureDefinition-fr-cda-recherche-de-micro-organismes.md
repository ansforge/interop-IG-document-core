# CDA - FR Recherche de micro organismes - ANS IG document core v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-recherche-de-micro-organismes | *Version*:0.1.0 |
| Draft as of 2026-02-26 | *Computable Name*:FRCDARechercheDeMicroOrganismes |

 
Entrée FR-Recherche-de-micro-organismes: <p>IHE PCC – Simple Observation </p> 
* Cette entrée permet d'indiquer si une recherche de micro-organismes multirésistants ou émergents a été effectuée ou pas.
