# CDA - FR Statut document - ANS IG document core v0.1.0
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "short" : "Statut du document Dans le cas où aucune réponse n'est disponible, la valeur nullFlavor='UNK' est autorisée. ",
      "min" : 1,
      "max" : "1",
      "type" : [{
