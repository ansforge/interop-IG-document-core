# CDA - FR Non remboursable - ANS IG document core v0.1.0
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "short" : "L'attribut @value pourra prendre l'une des deux valeurs suivantes :value='true' : le traitement prescrit n'est pas remboursablevalue='false' : le traitement prescrit est remboursable",
      "min" : 1,
      "max" : "1",
      "type" : [{
