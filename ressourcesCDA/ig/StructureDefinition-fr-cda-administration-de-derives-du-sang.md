# CDA - FR Administration de derives du sang - ANS IG document core v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-administration-de-derives-du-sang | *Version*:0.1.0 |
| Draft as of 2026-02-25 | *Computable Name*:FRCDAAdministrationDeDerivesDuSang |

 
Entrée FR-Administration-de-derives-du-sang: <p>IHE-PCC - Simple-Observation </p> 
* Cette entrée permet d'indiquer s'il y a eu ou pas une administration de dérivés du sang.
