# CDA - FR Observation sur la grossesse - ANS IG document core v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-observation-sur-la-grossesse | *Version*:0.1.0 |
| Draft as of 2026-02-26 | *Computable Name*:FRCDAObservationSurLaGrossesse |

 
Entrée FR-Observation-sur-la-grossesse: <p>IHE-PCC - Pregnancy Observation</p> 
* Cette entrée permet d'apporter des informations relatives aux grossesses actuelle ou passées. 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "short" : "Résultat de l’observation effectuée Valeur peut être issue du JDV_StatutGrossesse_CISIS (1.2.250.1.213.1.1.5.671) pour le statut de grossesse si le code de l'entrée est '11449-6'.",
      "min" : 1,
      "max" : "1",
      "type" : [{
