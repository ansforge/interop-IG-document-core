# CDA - FR En rapport avec accident travail - ANS IG document core v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-en-rapport-avec-accident-travail | *Version*:0.1.0 |
| Draft as of 2026-02-25 | *Computable Name*:FRCDAEnRapportAvecAccidentTravail |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "short" : "Résultat de l'observationL'attribut @value pourra prendre l'une des deux valeurs suivantes :value='true' : le traitement est prescrit dans le cadre d'un accident du travailvalue='false' : le traitement n'est pas prescrit dans le cadre d'un accident du travail",
      "min" : 1,
      "max" : "1",
      "type" : [{
