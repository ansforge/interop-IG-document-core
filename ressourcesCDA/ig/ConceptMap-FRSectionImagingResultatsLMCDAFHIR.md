...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/ConceptMap/FRSectionImagingResultatsLMCDAFHIR | *Version*:0.1.0 |
...
```json
{
  ...
  "id" : "FRSectionImagingResultatsLMCDAFHIR",
  "url" : "https://interop.esante.gouv.fr/ig/document/core/ConceptMap/FRSectionImagingResultatsLMCDAFHIR",
  "version" : "0.1.0",
