# CDA - FR En rapport avec ALD - ANS IG document core v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-en-rapport-avec-ald | *Version*:0.1.0 |
| Draft as of 2026-02-25 | *Computable Name*:FRCDAEnRapportAvecALD |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "short" : "Résultat de l'observationL'attribut @value pourra prendre l'une des deux valeurs suivantes :value='true' : le traitement est prescrit dans le cadre d'une affection longue durée (ALD)value='false' : le traitement n'est pas prescrit dans le cadre d'une affection longue durée (ALD)",
      "min" : 1,
      "max" : "1",
      "type" : [{
