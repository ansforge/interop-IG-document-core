...
* [Practitioner role](http://terminology.hl7.org/7.1.0/CodeSystem-practitioner-role.html): [Bundle/example-bundle-Prescription](Bundle-example-bundle-Prescription.md) and [PractitionerRole/ExamplePractitionerRoleRemplacant](PractitionerRole-ExamplePractitionerRoleRemplacant.md)
* [identifierType](http://terminology.hl7.org/7.1.0/CodeSystem-v2-0203.html): [Bundle/example-bundle-Prescription](Bundle-example-bundle-Prescription.md), [Composition/ExampleCompositionPrescription](Composition-ExampleCompositionPrescription.md), [FRPatientDocument](StructureDefinition-fr-patient-document.md) and [FRPatientINSDocument](StructureDefinition-fr-patient-ins-document.md)
...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      "name" : "ExampleOrganizationPrescription-03",
    ...
    },
    {
      ...
      "name" : "ExamplePractitionerRoleRemplacant",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "Composition/ExampleCompositionPrescription"
      },
