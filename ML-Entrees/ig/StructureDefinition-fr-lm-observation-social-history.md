...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-lm-observation-social-history | *Version*:0.1.0-snapsnot |
| Draft as of 2026-04-16 | *Computable Name*:FRLMObservationSocialHistory |
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "fr-lm-observation-social-history.status",
      "path" : "fr-lm-observation-social-history.status",
