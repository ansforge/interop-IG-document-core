# Logical model - FR LM Observation Long Term Condition - ANS IG document core v0.1.0-snapsnot
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-lm-observation-long-term-condition | *Version*:0.1.0-snapsnot |
| Draft as of 2026-04-16 | *Computable Name*:FRLMObservationLongTermCondition |
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "fr-lm-observation-long-term-condition.statut",
      "path" : "fr-lm-observation-long-term-condition.statut",
