...
| Draft as of 2026-04-09 | *Computable Name*:FRDocumentCore |
...
* [Substance Admin Substitution](http://terminology.hl7.org/7.1.0/CodeSystem-v3-substanceAdminSubstitution.html): [FRCDAAutorisationSubstitution](StructureDefinition-fr-cda-autorisation-substitution.md), [FRLMMedicationPrescription](StructureDefinition-fr-lm-medication-prescription.md), [FRLMTraitementDispense](StructureDefinition-fr-lm-traitement-dispense.md) and [FRMedicationRequestDocument](StructureDefinition-fr-medication-request-document.md)
