...
* [ConditionVerificationStatus](http://terminology.hl7.org/7.1.0/CodeSystem-condition-ver-status.html): [FRCDACertitude](StructureDefinition-fr-cda-certitude.md) and [FRLMAllergyIntolerance](StructureDefinition-fr-lm-allergy-intolerance.md)
