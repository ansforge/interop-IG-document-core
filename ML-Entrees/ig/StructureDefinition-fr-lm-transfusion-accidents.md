# Logical model - FR LM Transfusion accidents - ANS IG document core v0.1.0-snapsnot
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-lm-transfusion-accidents | *Version*:0.1.0-snapsnot |
| Draft as of 2026-04-16 | *Computable Name*:FRLMTransfusionAccidents |
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "fr-lm-transfusion-accidents.statut",
      "path" : "fr-lm-transfusion-accidents.statut",
