# Logical model - FR LM Observation Related to Prevention - ANS IG document core v0.1.0-snapsnot
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-lm-observation-related-to-prevention | *Version*:0.1.0-snapsnot |
| Draft as of 2026-04-16 | *Computable Name*:FRLMObservationRelatedToPrevention |
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "fr-lm-observation-related-to-prevention.statut",
      "path" : "fr-lm-observation-related-to-prevention.statut",
