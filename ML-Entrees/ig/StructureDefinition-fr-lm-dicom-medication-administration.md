# Logical model - FR LM DICOM Medication Administration - ANS IG document core v0.1.0-snapsnot
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-lm-dicom-medication-administration | *Version*:0.1.0-snapsnot |
| Draft as of 2026-04-16 | *Computable Name*:FRLMDICOMMedicationAdministration |
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "fr-lm-dicom-medication-administration.statut",
      "path" : "fr-lm-dicom-medication-administration.statut",
