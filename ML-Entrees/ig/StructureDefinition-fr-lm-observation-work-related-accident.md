# Logical model - FR LM Observation Work Related Accident - ANS IG document core v0.1.0-snapsnot
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-lm-observation-work-related-accident | *Version*:0.1.0-snapsnot |
| Draft as of 2026-04-16 | *Computable Name*:FRLMObservationWorkRelatedAccident |
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "fr-lm-observation-work-related-accident.statut",
      "path" : "fr-lm-observation-work-related-accident.statut",
