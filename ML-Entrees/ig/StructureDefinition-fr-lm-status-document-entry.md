# Logical model - FR LM Statut du document - ANS IG document core v0.1.0-snapsnot
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-lm-status-document-entry | *Version*:0.1.0-snapsnot |
| Draft as of 2026-04-16 | *Computable Name*:FRLMStatusDocumentEntry |
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "fr-lm-status-document-entry.statut",
      "path" : "fr-lm-status-document-entry.statut",
