# Logical model - FR LM Evolution Adverse Event - ANS IG document core v0.1.0-snapsnot
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-lm-evolution-adverse-event | *Version*:0.1.0-snapsnot |
| Draft as of 2026-04-16 | *Computable Name*:FRLMEvolutionAdverseEvent |
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "fr-lm-evolution-adverse-event.statut",
      "path" : "fr-lm-evolution-adverse-event.statut",
