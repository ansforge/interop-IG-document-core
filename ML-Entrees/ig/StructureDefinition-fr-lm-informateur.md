...
| Draft as of 2026-04-13 | *Computable Name*:FRLMInformateur |
...
* Utilise ce/t/te Modèle logique: [Modèle logique métier - FR LM Rencontre](StructureDefinition-fr-lm-encounter.md), [Modèle logique métier - FR LM En-tête document](StructureDefinition-fr-lm-entete-document.md), [FR LM Entry](StructureDefinition-fr-lm-entry.md) and [Modèle logique métier - FR LM Statut fonctionnel](StructureDefinition-fr-lm-statut-fonctionnel.md)
