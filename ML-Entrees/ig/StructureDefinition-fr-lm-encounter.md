...
* Utilise ce/t/te Modèle logique: [Modèle logique métier - FR LM Plan de soins](StructureDefinition-fr-lm-plan-soins.md) and [Logical model- FR LM Procedure](StructureDefinition-fr-lm-procedure.md)
