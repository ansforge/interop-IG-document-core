# Logical model - FR LM Adverse Event - ANS IG document core v0.1.0-snapsnot
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-lm-adverse-event | *Version*:0.1.0-snapsnot |
| Draft as of 2026-04-16 | *Computable Name*:FRLMAdverseEvent |
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "fr-lm-adverse-event.statut",
      "path" : "fr-lm-adverse-event.statut",
