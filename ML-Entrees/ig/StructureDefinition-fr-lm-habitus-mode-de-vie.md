...
| Draft as of 2026-04-13 | *Computable Name*:FRLMHabitusModeDeVie |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "max" : "*",
      "type" : [{
        "code" : "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fm-lm-observation-social-history"
      }]
    }]
  }
}
