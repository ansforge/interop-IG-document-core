...
| Draft as of 2026-04-08 | *Computable Name*:FRLMPatientUsager |
...
* Utilise ce/t/te Modèle logique: [Modèle logique métier - FR LM En-tête document](StructureDefinition-fr-lm-entete-document.md) and [FR LM Entry](StructureDefinition-fr-lm-entry.md)
