...
| Draft as of 2026-04-16 | *Computable Name*:FRLMParticipantCorps |
...
* Utilise ce/t/te Modèle logique: [Modèle logique métier - FR LM Autorisation exposition](StructureDefinition-fr-lm-autorisation-exposition.md) and [FR LM Entry](StructureDefinition-fr-lm-entry.md)
