# Logical model - FR LM Non remboursable - ANS IG document core v0.1.0-snapsnot
...
| Draft as of 2026-04-14 | *Computable Name*:FRLMNonRemboursable |
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "fr-lm-non-remboursable.status",
      "path" : "fr-lm-non-remboursable.status",
