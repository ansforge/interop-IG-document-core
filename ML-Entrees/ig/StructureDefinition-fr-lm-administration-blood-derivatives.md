# Logical model - FR LM Administration of Blood Derivatives - ANS IG document core v0.1.0-snapsnot
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-lm-administration-blood-derivatives | *Version*:0.1.0-snapsnot |
| Draft as of 2026-04-16 | *Computable Name*:FRLMAdministrationBloodDerivatives |
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "fr-lm-administration-blood-derivatives.statut",
      "path" : "fr-lm-administration-blood-derivatives.statut",
