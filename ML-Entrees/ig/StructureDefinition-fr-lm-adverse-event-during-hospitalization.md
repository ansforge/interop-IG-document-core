# Logical model - FR LM Adverse Events During Hospitalization - ANS IG document core v0.1.0-snapsnot
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-lm-adverse-event-during-hospitalization | *Version*:0.1.0-snapsnot |
| Draft as of 2026-04-16 | *Computable Name*:FRLMAdverseEventDuringHospitalization |
...
```json
{
  ...
  "differential" : {
    ...
    {
      "id" : "fr-lm-adverse-event-during-hospitalization.statut",
      "path" : "fr-lm-adverse-event-during-hospitalization.statut",
