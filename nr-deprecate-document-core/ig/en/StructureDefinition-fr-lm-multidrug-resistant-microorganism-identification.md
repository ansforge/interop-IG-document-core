# Logical model - FR LM Multidrug Resistant Microorganism Identification - ANS IG document core v0.1.0-snapshot
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.document.fr.core|current/StructureDefinition/StructureDefinition-fr-lm-multidrug-resistant-microorganism-identification.json)
