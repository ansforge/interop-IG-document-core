...
## Modèle logique: CDA - FR DICOM Quantite subordonnee 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-dicom-quantite-subordonnee.csv), [Excel](../StructureDefinition-fr-cda-dicom-quantite-subordonnee.xlsx) 
