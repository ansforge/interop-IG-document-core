...
## Modèle logique: CDA - FR Evenement 
...
Cette structure est dérivée de [Encounter](http://hl7.org/cda/stds/core/2.0.3-sd/StructureDefinition-Encounter.html) 
...
* [CDA - FR Transport du patient (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-transport-du-patient)](StructureDefinition-fr-cda-transport-du-patient.md)
* [CDA - FR Statut (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-statut)](StructureDefinition-fr-cda-statut.md)
* [CDA - FR Transport du professionnel (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-transport-du-professionnel)](StructureDefinition-fr-cda-transport-du-professionnel.md)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-evenement.csv), [Excel](../StructureDefinition-fr-cda-evenement.xlsx) 
