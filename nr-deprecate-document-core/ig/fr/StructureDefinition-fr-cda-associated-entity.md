...
## Modèle logique: CDA - associatedEntity 
...
Cette structure est dérivée de [AssociatedEntity](http://hl7.org/cda/stds/core/2.0.3-sd/StructureDefinition-AssociatedEntity.html) 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-associated-entity.csv), [Excel](../StructureDefinition-fr-cda-associated-entity.xlsx) 
