...
## Modèle logique: Logical model - FR LM ObservationResults 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-observation-results.csv), [Excel](../StructureDefinition-fr-lm-observation-results.xlsx) 
