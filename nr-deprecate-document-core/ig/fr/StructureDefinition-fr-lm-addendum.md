...
## Modèle logique: Logical model - FR LM Addendum 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-addendum.csv), [Excel](../StructureDefinition-fr-lm-addendum.xlsx) 
