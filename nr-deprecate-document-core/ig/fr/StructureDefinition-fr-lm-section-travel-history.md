...
## Modèle logique: Logical model - FR LM Travel History 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-section-travel-history.csv), [Excel](../StructureDefinition-fr-lm-section-travel-history.xlsx) 
