...
## Modèle logique: CDA - FR Document PDF copie 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-document-pdf-copie.csv), [Excel](../StructureDefinition-fr-cda-document-pdf-copie.xlsx) 
