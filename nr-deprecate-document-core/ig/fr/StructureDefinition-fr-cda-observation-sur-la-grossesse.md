...
## Modèle logique: CDA - FR Observation sur la grossesse 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-observation-sur-la-grossesse.csv), [Excel](../StructureDefinition-fr-cda-observation-sur-la-grossesse.xlsx) 
