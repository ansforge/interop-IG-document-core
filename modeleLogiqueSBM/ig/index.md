...
* [Condition Clinical Status Codes](http://terminology.hl7.org/7.1.0/CodeSystem-condition-clinical.html): [FRLMProblem](StructureDefinition-fr-lm-problem.md)
* [ConditionVerificationStatus](http://terminology.hl7.org/7.1.0/CodeSystem-condition-ver-status.html): [FRCDACertitude](StructureDefinition-fr-cda-certitude.md), [FRLMAllergyIntolerance](StructureDefinition-fr-lm-allergy-intolerance.md) and [FRLMProblem](StructureDefinition-fr-lm-problem.md)
...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/fr-lm-problem"
      },
      "name" : "Logical model - FR LM Problem",
