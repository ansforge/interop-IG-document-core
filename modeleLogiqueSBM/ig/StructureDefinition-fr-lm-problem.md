# Logical model - FR LM Problem - ANS IG document core v0.1.0-snapsnot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Logical model - FR LM Problem**

## Logical Model: Logical model - FR LM Problem 

| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-lm-problem | *Version*:0.1.0-snapsnot |
| Draft as of 2026-04-07 | *Computable Name*:FRLMProblem |
...
Other representations of profile: [CSV](StructureDefinition-fr-lm-problem.csv), [Excel](StructureDefinition-fr-lm-problem.xlsx) 
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-lm-problem",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-lm-problem",
  ...
  "differential" : {
    "element" : [{
      "id" : "fr-lm-problem",
      "path" : "fr-lm-problem",
      "short" : "Logical model - FR LM Problem",
      "definition" : "Entrée Problème"
    },
    {
      "id" : "fr-lm-problem.type",
      "path" : "fr-lm-problem.type",
    ...
    {
      "id" : "fr-lm-problem.problem",
      "path" : "fr-lm-problem.problem",
    ...
    {
      "id" : "fr-lm-problem.period",
      "path" : "fr-lm-problem.period",
      "short" : "Période",
      "definition" : "Période",
      "min" : 1,
      "max" : "1",
    ...
    {
      "id" : "fr-lm-problem.period.onsetDate",
      "path" : "fr-lm-problem.period.onsetDate",
      "short" : "Date de début",
    ...
    {
      "id" : "fr-lm-problem.period.endDate",
      "path" : "fr-lm-problem.period.endDate",
      "short" : "Date de fin",
    ...
    {
      "id" : "fr-lm-problem.severity",
      "path" : "fr-lm-problem.severity",
    ...
    {
      "id" : "fr-lm-problem.status",
      "path" : "fr-lm-problem.status",
    ...
    {
      "id" : "fr-lm-problem.clinicalStatus",
      "path" : "fr-lm-problem.clinicalStatus",
    ...
    {
      "id" : "fr-lm-problem.bodySite",
      "path" : "fr-lm-problem.bodySite",
    ...
    {
      "id" : "fr-lm-problem.stage",
      "path" : "fr-lm-problem.stage",
    ...
    {
      "id" : "fr-lm-problem.diagnosisAssertionStatus",
      "path" : "fr-lm-problem.diagnosisAssertionStatus",
      "short" : "Certitude",
    ...
    {
      "id" : "fr-lm-problem.reference",
      "path" : "fr-lm-problem.reference",
    ...
    {
      "id" : "fr-lm-problem.note",
      "path" : "fr-lm-problem.note",
      "short" : "commentaire",
