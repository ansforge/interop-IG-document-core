...
| Draft as of 2026-04-08 | *Computable Name*:FRLMEntry |
...
* Dérivé de ce Modèle logique: [Logical model - FR LM Allergy Intolerance](StructureDefinition-fr-lm-allergy-intolerance.md), [Logical model - FR LM Care Plan](StructureDefinition-fr-lm-care-plan.md), [Logical model - FR LM Condition](StructureDefinition-fr-lm-condition.md), [Logical model - FR LM Device use](StructureDefinition-fr-lm-device-use.md)... Show 3 more, [Logical model - FR LM Immunisation](StructureDefinition-fr-lm-immunisation.md), [Logical model - FR LM Observation Vital Sign](StructureDefinition-fr-lm-observation-vital-sign.md) and [Logical model- FR LM Procedure](StructureDefinition-fr-lm-procedure.md)
