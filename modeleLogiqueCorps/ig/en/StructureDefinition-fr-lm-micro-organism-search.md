# Logical model - FR LM Micro Organism Search - ANS IG document core v0.1.0-snapshot
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.document.fr.core|current/StructureDefinition/StructureDefinition-fr-lm-micro-organism-search.json)
