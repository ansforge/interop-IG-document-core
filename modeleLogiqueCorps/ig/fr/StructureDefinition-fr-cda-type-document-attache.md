...
## Modèle logique: CDA - FR Type document attache 
...
Obligatoire : 14 éléments(3 éléments obligatoire(s) imbriqué(s))
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-type-document-attache.csv), [Excel](../StructureDefinition-fr-cda-type-document-attache.xlsx) 
