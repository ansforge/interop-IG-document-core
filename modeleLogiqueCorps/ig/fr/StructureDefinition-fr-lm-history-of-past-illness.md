...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-history-of-past-illness.csv), [Excel](../StructureDefinition-fr-lm-history-of-past-illness.xlsx) 
