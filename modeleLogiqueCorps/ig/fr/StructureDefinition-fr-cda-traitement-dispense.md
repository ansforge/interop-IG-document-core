...
## Modèle logique: CDA - FR Traitement dispense 
...
Obligatoire : 13 éléments(2 éléments obligatoire(s) imbriqué(s))
...
* [CDA - FR Reference item prescription (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-reference-item-prescription)](StructureDefinition-fr-cda-reference-item-prescription.md)
...
* [CDA - FR Notes du dispensateur (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-notes-du-dispensateur)](StructureDefinition-fr-cda-notes-du-dispensateur.md)
* [CDA - FR Acte substitution (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-acte-substitution)](StructureDefinition-fr-cda-acte-substitution.md)
...
* The element 1 is sliced based on the value of Supply.entryRelationship
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-traitement-dispense.csv), [Excel](../StructureDefinition-fr-cda-traitement-dispense.xlsx) 
