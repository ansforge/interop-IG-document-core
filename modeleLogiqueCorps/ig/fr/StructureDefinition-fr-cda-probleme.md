...
## Modèle logique: CDA - FR Probleme 
...
* [CDA - FR Severite (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-severite)](StructureDefinition-fr-cda-severite.md)
* [CDA - FR Statut du probleme (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-statut-du-probleme)](StructureDefinition-fr-cda-statut-du-probleme.md)
* [CDA - FR Statut clinique du patient (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-statut-clinique-du-patient)](StructureDefinition-fr-cda-statut-clinique-du-patient.md)
* [CDA - FR Certitude (https://interop.esante.gouv.fr/ig/document/core/StructureDefinition/fr-cda-certitude)](StructureDefinition-fr-cda-certitude.md)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-probleme.csv), [Excel](../StructureDefinition-fr-cda-probleme.xlsx) 
