...
## Modèle logique: Logical model - FR LM Section 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-section.csv), [Excel](../StructureDefinition-fr-lm-section.xlsx) 
