...
## Modèle logique: Logical model - FR LM Traitements administrés 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-traitements-administres.csv), [Excel](../StructureDefinition-fr-lm-traitements-administres.xlsx) 
