...
## Modèle logique: CDA - FR Observation sur echelle douleur 
...
Obligatoire : 14 éléments(2 éléments obligatoire(s) imbriqué(s))
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-observation-sur-echelle-douleur.csv), [Excel](../StructureDefinition-fr-cda-observation-sur-echelle-douleur.xlsx) 
