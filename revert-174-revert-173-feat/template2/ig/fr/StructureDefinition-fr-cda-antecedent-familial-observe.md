...
## Modèle logique: CDA - FR Antecedent familial observe 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-antecedent-familial-observe.csv), [Excel](../StructureDefinition-fr-cda-antecedent-familial-observe.xlsx) 
