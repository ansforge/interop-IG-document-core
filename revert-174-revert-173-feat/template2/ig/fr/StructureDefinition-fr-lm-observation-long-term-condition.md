...
## Modèle logique: Logical model - FR LM Observation Long Term Condition 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-observation-long-term-condition.csv), [Excel](../StructureDefinition-fr-lm-observation-long-term-condition.xlsx) 
