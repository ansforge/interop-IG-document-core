...
## Modèle logique: Logical model - FR LM Identification de micro-organismes multirésistants 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-identification-de-micro-organismes-multiresistants.csv), [Excel](../StructureDefinition-fr-lm-identification-de-micro-organismes-multiresistants.xlsx) 
