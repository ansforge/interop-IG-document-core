...
## Modèle logique: Logical model - FR LM Observation Related to Prevention 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-observation-related-to-prevention.csv), [Excel](../StructureDefinition-fr-lm-observation-related-to-prevention.xlsx) 
