...
## Modèle logique: Logical model- FR LM Synthese medicale sejour 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-synthese-medicale-sejour.csv), [Excel](../StructureDefinition-fr-lm-synthese-medicale-sejour.xlsx) 
