...
## Modèle logique: CDA - FR Item plan traitement 
...
Obligatoire : 11 éléments(5 éléments obligatoire(s) imbriqué(s))
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-item-plan-traitement.csv), [Excel](../StructureDefinition-fr-cda-item-plan-traitement.xlsx) 
