...
## Modèle logique: Logical model - FR LM Vital Signs 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-lm-vital-signs.csv), [Excel](../StructureDefinition-fr-lm-vital-signs.xlsx) 
