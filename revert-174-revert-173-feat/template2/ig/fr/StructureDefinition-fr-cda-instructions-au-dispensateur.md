...
## Modèle logique: CDA - FR Instructions au dispensateur 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-cda-instructions-au-dispensateur.csv), [Excel](../StructureDefinition-fr-cda-instructions-au-dispensateur.xlsx) 
